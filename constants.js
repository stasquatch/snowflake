...
export type TrackId = 'TECHNICAL_SCOPE' | 'DELIVERY' | 'SYSTEMS_THINKING' | 'COLLABORATION_COMMUNICATION' |
  'MENTORING' | 'LEARNING_MINDSET' | 'VISION'
export type Milestone = 0 | 1 | 2 | 3 | 4 | 5

export type MilestoneMap = {
  'TECHNICAL_SCOPE': Milestone,
  'DELIVERY': Milestone,
  'SYSTEMS_THINKING': Milestone,
  'COLLABORATION_COMMUNICATION': Milestone,
  'MENTORING': Milestone,
  'LEARNING_MINDSET': Milestone,
  'VISION': Milestone
}
...
type Tracks = {|
  'TECHNICAL_SCOPE': Track,
  'DELIVERY': Track,
  'SYSTEMS_THINKING': Track,
  'COLLABORATION_COMMUNICATION': Track,
  'MENTORING': Track,
  'LEARNING_MINDSET': Track,
  'VISION': Track
|}
...
export const tracks: Tracks = {
  ...
  "COLLABORATION_COMMUNICATION": {
    "displayName": "Collaboration & Communication",
    "category": "C",
  ...
  "MENTORING": {
    "displayName": "Mentoring/Inspiring",
    "category": "C",
